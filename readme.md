# AI Based Traffic Density Detection and Traffic Jam Prediction
...
Traffic congestion is a major problem in urban environments, as the congestion of
...
### Project Objectives:
1. Conduct a literature review on currently used traffic systems, and vehicle
detection and traffic prediction models.
2. Investigate and analyse the Cityflow Dataset, as well as preprocess the dataset
for system development.
3. Develop a vehicle detection and counting system using computer vision
techniques.
4. Generate a traffic density time-series dataset from the CityFlow video data.
5. Develop the machine learning models to predict future traffic density and
congestion.
6. Evaluate system performance using testing data from the CityFlow Dataset.
7. Validate the system using additional datasets (METR-LA Dataset) to assess model
robustness and generalization, if necessary.
8. Evaluate the effectiveness of AI-based traffic monitoring systems.